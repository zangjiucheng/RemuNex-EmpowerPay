...
/**
 * This is the comparator class for the salary of the staff.
 * 
 * @version 1.1
 * @since 2023/5/4
...
public class SalaryComparator<T> implements Comparator<T> {
    ...
    public SalaryComparator(Class<T> cls) {
        type = cls;
    }
    ...
    public int compare(T o1, T o2) {
        if (getType().equals(Teacher.class)) {
            ...
            return String.valueOf(t1.getSalary()).compareTo(String.valueOf(t2.getSalary()));
